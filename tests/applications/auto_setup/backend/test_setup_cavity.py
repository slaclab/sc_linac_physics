...
def test_request_ssa_cal_true(cavity):
    ...
    cavity.rack.rfs1._rfs1_dac_amp_pv_obj = make_mock_pv()
    cavity.rack.rfs2._rfs2_dac_amp_pv_obj = make_mock_pv()
    ...
    cavity._progress_pv_obj.put.assert_called()
    cavity.check_abort.assert_called()
    cavity.rack.rfs2._rfs2_dac_amp_pv_obj.put.assert_called()
    cavity.rack.rfs1._rfs1_dac_amp_pv_obj.put.assert_called()
