...
class Magnet(linac_utils.SCLinacObject):
    """
    ...
    def reset(self):
        self.control_pv_obj.put(linac_utils.MAGNET_RESET_VALUE)

    def turn_on(self):
        self.control_pv_obj.put(linac_utils.MAGNET_ON_VALUE)

    def turn_off(self):
        self.control_pv_obj.put(linac_utils.MAGNET_OFF_VALUE)

    def degauss(self):
        self.control_pv_obj.put(linac_utils.MAGNET_DEGAUSS_VALUE)
