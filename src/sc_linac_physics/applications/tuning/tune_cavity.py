...
class TuneCavity(Cavity):
    ...
    def detune_no_rf(self, count_current=False):
        ...
        self.stepper_tuner.move_to_cold_landing(count_current=count_current, check_detune=False)
    ...
    def detune_by_steps(self, count_current):
        ...
        self.stepper_tuner.move_to_cold_landing(count_current=count_current, check_detune=True)
