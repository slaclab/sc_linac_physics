...
from sc_linac_physics.applications.microphonics.utils.pv_utils import extract_cavity_channel_from_pv
...
def _structure_parsed_data(
    channel_pvs: List[str], data_array: np.ndarray, file_path: Path, decimation: int = 1
) -> Dict[str, Any]:
